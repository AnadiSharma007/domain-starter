...
// Constants
const TWITTER_HANDLE = "anadis748";
const TWITTER_LINK = `https://twitter.com/${TWITTER_HANDLE}`;
const tld = ".hellothere";
const CONTRACT_ADDRESS = "0xde1293200b31c83BcB6038385e12C89239bBCc60";
    ...
    return (
      <div className="form-container">
        ...
        <input
          type="text"
          value={record}
          placeholder="why do you need hellothere"
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <header>
            <div className="left">
              <p className="title">🐱‍👤 HelloThere Name Service</p>
